...
func authCreateCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE:  wrapCheckSetup(&flags)(authorizationCreateF),
	}
...
func authFindCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE:  wrapCheckSetup(&flags)(authorizationFindF),
	}
...
func authDeleteCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE:  wrapCheckSetup(&flags)(authorizationDeleteF),
	}
...
func authActiveCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE:  wrapCheckSetup(&flags)(authorizationActiveF),
	}
...
func authInactiveCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE:  wrapCheckSetup(&flags)(authorizationInactiveF),
	}
